jQuery.extend({
    ...
    when: function( subordinate /* ,..., subordinateN */ ) {
        var i = 0,
            ...
            // master Deferred. If resolveValues consist of sing Deferred, use it
            deferred = remaining === 1
                            ? subordinate : jQuery.Deferred(),

            // update function for #resolve and #progress values
...
//                    } else if( !(--remaining) ) {
                    } else if( remaining > 0 ) { console.log('remaining:' + remaining)
        ...
        // if not waiting on anything, resolve master
        if( !remaining ) {
